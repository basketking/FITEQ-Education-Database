...
nf_list = ['Algeria', 'Benin', 'Burkina Faso','Burundi', 'Cameroon', 'Cape Verde', 'Chad', 'Djibouti', 'Equatorial Guinea', 'Eswatini', 'Gabon', 'Gambia', 'Ghana', 'Guinea', 'Guinea-Bissau', 'Ivory Coast', 'Kenya', 'Lesotho', 'Liberia', 'Madagascar', 'Malawi', 'Mali', 'Mauritius', 'Nigeria', 'Rwanda', 'Senegal', 'Seychelles', 'Sierra Leone', 'Somalia', 'South Africa','Sao Tome and Principe', 'Togo', 'Tunisia', 'Zambia', 'Zimbabwe', 'Afghanistan', 'Bahrain', 'Brunei', 'Cambodia', 'Costa Rica', 'El Salvador', 'Argentina', 'Israel', 'Australia', 'Hong Kong China', 'India', 'Indonesia', 'Iran', 'Iraq', 'Japan', 'Jordan', 'Kazakhstan', 'Kuwait', 'Kyrgyzstan', 'Lebanon', 'Malaysia', 'Mongolia', 'Nepal', 'Pakistan', 'Palestine', 'Philippines', 'Republic of Korea', 'Singapore', 'Sri Lanka', 'Syria', 'Tajikistan', 'Thailand', 'Timor-Leste', 'Turkmenistan', 'Uzbekistan', 'Yemen', 'Albania', 'Armenia', 'Austria', 'Belgium', 'Bosnia and Herzegovina', 'Bulgaria', 'Croatia', 'Czech Republic', 'France', 'Georgia', 'Hungary', 'Italy', 'Kosovo', 'Luxembourg', 'Malta', 'Moldova', 'Montenegro', 'North Macedonia', 'Norway', 'Poland', 'Portugal', 'Romania', 'Serbia', 'Slovakia', 'Slovenia', 'Switzerland', 'Ukraine', 'Cook Islands', 'Guam', 'New Caledonia', 'Papua New Guinea', 'Samoa', 'Tuvalu', 'Vanuatu', 'Antigua and Barbuda', 'Bahamas', 'Belize', 'Bermuda','Brazil', 'Canada', 'Chile', 'Guatemala', 'Guyana', 'Haiti', 'Jamaica', 'Mexico', 'Panama', 'Peru', 'Saint Kitts and Nevis','Saint Lucia', 'Trinidad and Tobago', 'United States', 'Uruguay', 'Venezuela']
